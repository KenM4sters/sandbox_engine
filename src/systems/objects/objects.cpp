...
void SObjects::Init() {
    ...
    cube_mesh->transforms_.position = glm::vec3(0.0f, 15.0f, 0.0f);
    ...
    back_pack->transforms_->position = glm::vec3(-2.0f, 15.0f, -4.0f);
    ...
    m_p1->transforms_->position = glm::vec3(5.0f, 14.0f, -4.0f);
    models_["m_p1"] = m_p1;
