...
BUILD_DIR = bin
C_FILES = ./src/*.cpp ./src/context/*.cpp ./src/scene/*.cpp ./src/resources/*.cpp ./src/mesh/*.cpp ./src/mesh/material/*.cpp ./src/mesh/geometry/*.cpp ./src/camera/*.cpp
HEADER_FILES = -I./src/utils/*.h -I./src/*.h -I./src/context/*.h -I./src/scene/*.h -I./src/resources/*.h -I./src/mesh/*.h -I./src/mesh/geometry/*.h -I./src/mesh/material/*.h  -I./src/camera/*.h
