...
BUILD_DIR = bin
C_FILES = ./src/*.cpp ./src/context/*.cpp ./src/scene/*.cpp ./src/resources/*.cpp  ./src/camera/*.cpp ./src/systems/*.cpp ./src/systems/lights/*.cpp ./src/systems/objects/*.cpp ./src/systems/skybox/*.cpp ./src/systems/terrain/*.cpp
