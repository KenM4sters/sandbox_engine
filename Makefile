...
BUILD_DIR = bin
C_FILES = ./src/*.cpp ./src/context/*.cpp ./src/scene/*.cpp ./src/resources/*.cpp  ./src/camera/*.cpp ./src/systems/*.cpp ./src/systems/lights/*.cpp ./src/systems/objects/*.cpp ./src/systems/skybox/*.cpp
HEADER_FILES = -I./src/utils/*.h -I./src/*.h -I./src/context/*.h -I./src/scene/*.h -I./src/resources/*.h -I./src/camera/*.h -I./src/systems/*.h -I./src/systems/lights/*.h -I./src/systems/objects/*.h -I./src/systems/skybox/*.h
